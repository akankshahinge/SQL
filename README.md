...
- Database has three levels of abstraction - Physical Level (data files, ligs, catalogs, partiton, blocks), Logical Level(tables, relationship, views, index, function, procedure), View Level (view for data 
  analyst, view for stakeholders, views for visualization)
  ```
